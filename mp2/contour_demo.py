...
if __name__ == '__main__':
  ...
  output_dir = 'contour-output/2b'; fn = compute_edges_dxdy;
  ...
  ax = fig.gca()
  file_name = os.path.join(output_dir + '_out_2b.txt')
  with open(file_name, 'wt') as f:
    display_results(ax, f, sample_results, threshold_results, overall_result)
  fig.savefig(os.path.join(output_dir + '_pr_2b.pdf'), bbox_inches='tight')
